...
Source changes are not yet verified in an installed build. The historical dev.235 login proof and authenticated discovery establish the basic driver, input and capture feasibility, not this contract's complete acceptance. Full replay remains pending the updated app and the remaining routine discovery.
