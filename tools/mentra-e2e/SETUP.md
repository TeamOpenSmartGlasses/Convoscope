...
4. Allow sufficient disk space for dependencies, Pods, Swift packages and derived data. The native build is substantially larger than the standalone replay helper.
