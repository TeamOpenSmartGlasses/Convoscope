...
| `compress` | React Native, Android, iOS | Upload compression: `none`, `low`, `medium`, or `high`. Omitted native values default to `none`. |
...
| `compress` | Upload compression for action-button photos: `none`, `low`, `medium`, or `high`. |
